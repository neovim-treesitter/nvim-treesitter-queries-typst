...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-typst/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-typst/actions/workflows/validate.yml)

Neovim tree-sitter queries for **typst**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-typst",
...
- [ ] Changes are scoped to `typst` — do not include files for other languages
